...
function displayJournalEntries() {
  ...
  if (selectedWeek === "week1") {
    ...
    <h3 style="display: inline;">Après-midi : </h3><span> Cet après-midi, mon tuteur de stage, Arnaud PANSE, m'a créé mon espace intranet
    ...
    <h3 style="display: inline;">Matin : </h3><span> Ce matin, j'ai eu un entretien avec Arnaud ROUSSET, un Product Owner (PO) en informatique,
    ...
    <h3 style="display: inline;">Matin : </h3><span> À 9h, j'ai assisté à la réunion quotidienne du projet CRM. Ensuite, j'ai rejoint Hinda en pair programming
     pour ajouter des contacts à la liste de contacts d'un service de compte. Grâce à notre travail en binôme, nous avons atteint le résultat souhaité et avons
      pu merger notre branche sur l'US. Ensuite à 11h, avec toute l'équipe de dev nous avons fait la démonstration du sprint 6 à Julien VIANO, le client.</span><br>
    ...
    <h3 style="display: inline;">Après-midi : </h3><span> Cet après-midi, j'ai eu l'occasion de discuter à nouveau avec Guillaume, le spécialiste en CSS. Ensemble, nous avons
    ...
    <h3 style="display: inline;">Matin : </h3><span> Ce mardi, la journée a débuté avec la traditionnelle réunion quotidienne à 9 heures. Ensuite, j'ai rempli mon rôle de 
    stagiaire avec Flavio et Margot en effectuant les courses nécessaires pour la soirée de fin de saison <b>Norsys</b> qui se tiendra jeudi soir. Ensuite, Margot et moi avons 
    organisé le tournoi de babyfoot qui réunit 20 employés de l'agence de Lyon et qui se déroule entre midi et deux heures. Nous avons assumé la responsabilité de la gestion 
    et de la planification des horaires des matchs.</span><br>
    <h3 style="display: inline;">Après-midi : </h3><span> Dans l'après-midi, j'ai pu avancer sur ma user story qui m'était dédiée. J'ai commencé par effectuer ma task 
    ...
    possibilité de m'entretenir avec Arnaud ROUSSET afin de faire le point sur mon stage, d'aborder les compétences que j'ai acquises jusqu'à présent et d'échanger
     sur mes impressions. Enfin, à 19h, a débuté à l'agence une soirée "Murder party" où l'un de nos collègues est mort dans d'étrange circonstance. Une ambiance 
    ...
    <h3 style="display: inline;">Matin : </h3><span>  J'ai entamé ma journée en rencontrant Arnaud PANSE pour faire le point sur mon stage et effectuer les tâches 
    ...
    <h3 style="display: inline;">Après-midi : </h3><span> L'après-midi, j'ai eu un entretien avec Arnaud ROUSSET durant lequel je lui ai présenté l'ensemble de mes 
    ...
    pendant ces 6 semaines de stage. Enfin, j'ai eu l'honneur d'échanger avec Sétaré COUSIN la directrice d'agence de Lyon pour un potentiel stage en janvier 2024.

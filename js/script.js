function displayJournalEntries() {
  ...
  if (selectedWeek === "week1") {
    ...
    <div class="service__icon" style="float: right;">
      <img src="img/t2.jpg" alt="Votre photo" style="border-radius: 50%; object-fit: cover; width: 100%; height: 100%;">
    </div>
    ...
    <h3 style="display: inline;">Matin : </h3><span> A 9h réunion daily du projet CRM. Puis  à 10h réunion avec 
    Hinda, Michael et moi-même pour la présentation code du projet CRM avec explication des "tests". </span><br>
    <h3 style="display: inline;">Après-midi : </h3><span> La réunion s'est poursuivis avec Michael et Hinda mais cette fois ci sur un autre sujet : 
    Hibernate. Michael nous a remis deux livres qu'il nous a conseillés de lire : "Clean code" et "Unit Testing".</span>

    <h2>Mercredi 31 mai 2023</h2>
    <h3 style="display: inline;">Matin : </h3><span> A 9h réunion daily du projet CRM. Ensuite, j'ai poursuivis une nouvelle fois les cours Udemy 
    sur Angular et Java.</span><br>
